...
#plotProfile -m Acclimation_1_31_5c_R1_paired_bismark_bt2_pe.deduplicated.bam_sorted.bam.bw_matrix.mat.gz -out Acclimation_1_31_5c.pdf --plotTitle "Acclimation_1_31_5c" --plotHeight 10 --plotWidth 10

plotHeatmap -m Acclimation_1_31_5c_R1_paired_bismark_bt2_pe.deduplicated.bam_sorted.bam.bw_matrix.mat.gz -out Acclimation_1_31_5c_heatmap.pdf 
